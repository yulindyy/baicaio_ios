...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *bgImageHeght;
...
- (void)setModel:(PrivateLetterModel *)model{
    ...
    _bgImageHeght.constant = inforect.size.height + 20;
    _bgimageWidth.constant = inforect.size.width + 15;
