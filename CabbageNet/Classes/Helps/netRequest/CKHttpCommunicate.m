...
{
    setDickeyobj(param, @"bSvfzr9r3G2lc5zfl90s27hhlf6hoecmecmc0WL", @"appkey");
    setDickeyobj(param, @"1.0", @"version");
    setDickeyobj(param, @"ios", @"from");
    
//    if ([ConsumerUserModel sharedUserData].mEU_uid.length == 0) {
//        setDickeyobj(param, @"", @"uid");
//        setDickeyobj(param, @"", @"sign");
//    }else{
//        setDickeyobj(param, [ConsumerUserModel sharedUserData].mEU_uid, @"uid");
//        setDickeyobj(param, [ConsumerUserModel sharedUserData].mEU_sign, @"sign");
//    }
...
- (void)createUnloginedRequest:(HTTP_COMMAND_LIST)taskID WithParam:(NSMutableDictionary *)param withMethod:(HTTPRequestMethod)method success:(void(^)(id result))success failure:(void(^)(NSError *erro))failure showHUD:(UIView *)showView
{
