...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // 设置键盘监听管理
    [[[IQKeyboardManager sharedManager] disabledDistanceHandlingClasses] addObjectsFromArray:@[[AllCommentViewController class],[IntegralDetailViewController class],[PrivateViewController class]]];
...
//    }
    ...
    /* 设置友盟appkey */
    [[UMSocialManager defaultManager] setUmSocialAppkey:@"59e83f77b27b0a0318000716"];
