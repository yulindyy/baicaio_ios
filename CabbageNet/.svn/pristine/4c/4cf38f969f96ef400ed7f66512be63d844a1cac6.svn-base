...
//        self.layer.position = CGPointMake(10, self.layer.position.y-self.frame.size.height*0.5);
...
- (UITableView *)myTabelView{
   ...
   // _myTabelView.separatorStyle  = UITableViewCellSeparatorStyleNone;
    [_myTabelView setSeparatorInset:UIEdgeInsetsZero];
    _myTabelView.alpha = 0.7;
