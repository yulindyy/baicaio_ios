...
//  CabbageNet
//
//  Created by ferver7 on 2017/5/22.
//  Copyright © 2017年 MacAir. All rights reserved.
//

#import "SearchCellTableViewCell.h"
@interface SearchCellTableViewCell ()
...
//    }
    ...
    [self.commentBtn setTitle:[NSString stringWithFormat:@"%ld", model.likes] forState:UIControlStateNormal];
